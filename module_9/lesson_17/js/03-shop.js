...
container.insertAdjacentHTML("beforeend", createMerkup(instruments))
...
function handlerClick(event) {
    ...
    const parentEl = event.target.closest(".js-product");
    const productId = Number(parentEl.dataset.id);
